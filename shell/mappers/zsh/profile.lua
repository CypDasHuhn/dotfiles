...
local function generate_path_file(paths, vars, machine, output_dir)
	...
	if #path_entries > 0 then
		table.insert(lines, 'export PATH="' .. table.concat(path_entries, ":") .. ':$PATH"')
	end

	table.insert(lines, "")

	local output_path = output_dir .. "/path.zsh"
...
%s() {
  cd "$%s"
	...
	local platform_dir = abs_modules_dir .. "/zsh"
	...
	if paths and #paths > 0 then
		...
		if path_ok then
			...
			table.insert(lines, 'source "' .. abs_output_dir .. '/path.zsh"')
		end
	end
