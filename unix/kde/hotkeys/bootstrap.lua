...
if not binds then
	print("[keyd] Failed to load binds: " .. (err or "unknown"))
	return
end
...
if not f then
	print("[keyd] Could not write: " .. generated_path)
	return
end
f:write(content)
f:close()
print("[keyd] Generated: " .. generated_path)
